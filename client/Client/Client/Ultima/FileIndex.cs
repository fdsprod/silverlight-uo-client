...
namespace Client.Ultima
{
    public class FileIndex
    {
        ...
        public FileIndex(string idxFile, string mulFile, int length, int file)
        {
            ...
            m_IndexPath = Path.Combine(@"C:\Games\Ultima Online Stygian Abyss Classic", idxFile);
            m_MulPath = Path.Combine(@"C:\Games\Ultima Online Stygian Abyss Classic", mulFile);
